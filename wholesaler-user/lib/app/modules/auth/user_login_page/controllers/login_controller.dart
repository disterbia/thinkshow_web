...
class User_LoginPageController extends GetxController {
  ...
  Future<void> loginBtnPressed(BuildContext context) async {
    if (usernameController.text.isEmpty) {
      mSnackbar(message: '아이디를 입력해주세요.'.tr,context: context);
      return;
    }
    if (passwordController.text.isEmpty) {
      mSnackbar(message: '비밀번호를 입력해주세요.'.tr,context: context);
      return;
    }
  ...
  // USER Login Process
  Future<bool> userLoginProcess(BuildContext context) async {
