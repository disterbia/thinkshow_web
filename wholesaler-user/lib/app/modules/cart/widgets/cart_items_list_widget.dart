...
class CartItemsList extends StatelessWidget {
                ...
                children: [
                  ...
                  products.length > 0
                      ? Padding(
                          ...
                          child: _store(cartItems[cartIndex].store,context),
                        )
                      : SizedBox.shrink(),
                  ...
                  ...products.map(
                    (product) => _orderedProductBuilder(
                        cartIndex, products.indexOf(product), product,context),
                  ),
                ],
              );
            },
  ...
  Widget _store(Store store,BuildContext context) {
  ...
  Widget _orderedProductBuilder(
      int cartIndex, int productIndex, Product product,BuildContext context) {
