...
class StoreDetailView extends GetView {
              ...
              ? Column(
                  ...
                  children: [
                    titleBuilder('띵동 배송', 'view_more'.tr, () {
                      context.go(MyRoutes.Tab4DingDongView);
                    }),
  ...
  Widget _starStore(BuildContext context) {
    return Positioned(
      right: 5,
      child: Padding(
          ...
          () => ctr.mainStoreModel.value.isFavorite != null
              ? IconButton(
                  onPressed: () {
                    ...
                    ctr.starIconPressed(context).then((_) {
                      if (prevPage != null) {
                        print(prevPage);
                        if (prevPage == 'rank') {
                          ctr2.getRankedStoreData(context);
                        } else if (prevPage == 'bookmark')
                          ctr2.getBookmarkedStoreData(context);
                      }
