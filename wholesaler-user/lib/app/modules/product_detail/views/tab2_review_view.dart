...
class Tab2ReviewView extends GetView {
  ...
  Widget _reviewItemBuilder(Review review,BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Divider(thickness: 1, color: MyColors.grey1),
        _header(review,context),
  ...
  Widget _header(Review review,BuildContext context) {
    return Row(
      children: [
        Text(
        ...
        Spacer(),
        ReportEditDeleteButtons(review,context),
      ],
    );
  }
  ...
  ReportEditDeleteButtons(Review review,BuildContext context) {
    if (review.isMine != null && review.isMine!) {
      ...
      return TextButton(
        onPressed: () => mSnackbar(message: '신고 되었습니다.',context: context),
        child: Text(
          '신고하기',
